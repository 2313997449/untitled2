...
public class SubjectDao {
    ...
    public int get(int id,String subjectname,int classhour,int gradeid) {
        //修改
        String sql2 = "UPDATE s_subject SET subjectname=?,classhour=?,gradeid=? where id =?";
        Connection con = DBUtil.getConnection();
